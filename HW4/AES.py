...
def main():
    if len(sys.argv) != 5:#takes in five arguments: script.py file, -e/-d, message.txt file name, key.txt file name and cipherhex.txt file name
        sys.exit ("Error, to encrypt or decrptypt, the script requires: python3 <script>.py -<e or d> <input file>.txt key.txt <output file>.txt")
